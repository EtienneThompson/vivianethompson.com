...
import error_404 from "@/views/errors/error_404.vue";
...
const routes = [
  ...
  {
    path: "/services/business_consulting",
    name: "Business Consulting",
    component: business_consulting,
  },
  {
    path: "/services/business_solutions",
    name: "Business Solutions",
    component: business_solutions,
  },
  {
    path: "/services/income_taxes",
    name: "Income Taxes",
    component: income_taxes,
  },
  {
    path: "/services/personal_finance",
    name: "Personal Finance",
    component: personal_finance,
  },
  { path: "/faqs", name: "FAQs", component: faqs },
  {
    path: "/quickbooks/best_or_beast",
    name: "QuickBooks? Best or Best?",
    component: best_or_beast,
  },
  {
    path: "/quickbooks/why",
    name: "Why QuickBooks?",
    component: why_quickbooks,
  },
  { path: "/login", name: "Client Login", component: client_login },
  { path: "/analytics/dashboard", name: "Analytics", component: dashboard },
  {
    path: "/forensic_accounting",
    name: "Forensic Accounting",
    component: forensic_accounting,
  },
  {
    path: "/services/millionaire_next_door",
    name: "Millionaire Next Door",
    component: millionaire_next_door,
  },
  { path: "/404", name: "404 Not Found", component: error_404 },
  { path: "*", redirect: "/404" },
];

...
async function main() {
  ...
  for (let client of clients) {
    ...
    let clientName;
    let clientServices = [];
    // Get the useful information from the client.
    ...
    for (let serviceId of clientServices) {
      ...
      // Custom frequency services are created manually.
      if (freq === "Custom") {
        continue;
      }
      ...
      console.log(`Need to create new work item for service ${serviceMap[serviceId.id].service_name}...`);
